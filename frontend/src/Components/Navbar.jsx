...
const Navbar = () => {
	return (
		<div><header className="p-4 bg-gray-800 text-gray-100">
			<div className="container flex justify-between h-16 mx-auto">
				<a rel="noopener noreferrer" href="#" aria-label="Back to homepage" className="flex items-center text-xl font-bold p-2">
			...
			<li className="flex">
				...
				<div className="flex justify-center items-center gap-3	">
					<p className='text-xl'>Juned Khan</p>
					<span>
